...
class TokensTests extends FlatSpec with Matchers {
  ...
  it should "add one positive and one negative numbers" in {
    assert(add(LNumber(-4), LNumber(3)) == LNumber(-1))
  }
  ...
  it should "subtract a positive and negative number" in {
    assert(sub(LNumber(-4), LNumber(3)) == LNumber(-7))
  }
  ...
  it should "multiply a positive and negative number" in {
    assert(mul(LNumber(4), LNumber(-3)) == LNumber(-12))
  }
  ...
  it should "divide a positive and negative number" in {
    assert(div(LNumber(12), LNumber(-3)) == LNumber(-4))
  }
  ...
  it should "get the head of a list 2" in {
    // car of (a b 3) is a (with int)
    assert(car(LList(LSymbol("a"),
                     LList(LSymbol("b"),
                           LList(LSymbol("3"),
                                 LSymbol("nil"))))) == LSymbol("a"))
  ...
  "cdr" should "get the tail of a list" in {
   ...
   it should "get the tail of a list 2" in {
    // cdr of (a b 7) is (b 7)
    assert(cdr(LList(LSymbol("a"),
                     LList(LSymbol("b"),
                           LList(LSymbol("7"),
  ...
  it should "handle eq for true condition: (eq 5 5)" in {
    assert(eval(LList(LSymbol("eq"),
                      LList(LNumber(5),
  ...
  it should "handle eq for true condition: (eq (quote a) (quote a))" in {
   ...
   it should "handle eq for false condition: (eq (quote a) (quote z))" in {
    assert(eval(LList(LSymbol("eq"),
                      LList(LList(LSymbol("quote"),
                                  LList(LSymbol("a"),LSymbol("nil"))),
                            LList(LList(LSymbol("quote"),
                                        LList(LSymbol("z"),LSymbol("nil"))),
                                  LSymbol("nil")))))
           == LSymbol("nil"))
  }
  ...
  it should "work: (eval (quote (- 60 45)))" in {
    assert(eval(LList(LSymbol("eval"),
                      LList(LList(LSymbol("quote"),
                                  LList(LList(LSymbol("-"),
                                              LList(LNumber(60),
  ...
  it should "work: (eval (quote (* 60 20)))" in {
    assert(eval(LList(LSymbol("eval"),
                      LList(LList(LSymbol("quote"),
                                  LList(LList(LSymbol("*"),
                                              LList(LNumber(60),
  ...
  //My extra cases I have included up top as extra cases with the corresponding test case
}
